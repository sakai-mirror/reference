...
ALTER TABLE VALIDATIONACCOUNT_ITEM MODIFY COLUMN SURNAME VARCHAR(255) NULL DEFAULT NULL;
ALTER TABLE VALIDATIONACCOUNT_ITEM MODIFY COLUMN FIRST_NAME VARCHAR(255) NULL DEFAULT NULL;
...
ALTER TABLE SAKAI_POSTEM_GRADEBOOK ADD file_reference varchar(255) DEFAULT NULL;
-- END SAK-26237

-- BEGIN SAK-26238: Syllabus start/stop dates
ALTER TABLE SAKAI_SYLLABUS_DATA ADD START_DATE datetime DEFAULT NULL;
ALTER TABLE SAKAI_SYLLABUS_DATA ADD END_DATE datetime DEFAULT NULL;
ALTER TABLE SAKAI_SYLLABUS_DATA ADD LINK_CALENDAR bit(1) DEFAULT NULL;
...
ALTER TABLE SAKAI_SYLLABUS_ITEM ADD openInNewWindow bit(1) DEFAULT NULL;
--END SAK-23877
